...
function mainAttack(feature){
  ...
  geometry2.push(ms.geometry.toDistanceBearing(arrowHead, width*(1-widthHeadRatio), direction+90))
  geometry2.push(ms.geometry.toDistanceBearing(points[0], width*(1-widthHeadRatio)*Math.abs((1/Math.tan(deltaDirection*(Math.PI/180)))), direction-180))
  geometry2.push(ms.geometry.toDistanceBearing(arrowHead2, width*(1-widthHeadRatio), direction-90))
