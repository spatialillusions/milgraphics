...
function counterattack(feature) {
    ...
    //   annotations[i] = {};
    //   annotations[i].geometry = { type: "Point" };
    //   annotations[i].properties = {};
    //   annotations[i].properties.text = i.toString();
    //   annotations[i].geometry.coordinates = feature.geometry.coordinates[i];
    // }

    annotations[0] = {};
      annotations[0].geometry = { type: "Point" };
      annotations[0].properties = {};
      annotations[0].properties.text = "CATK";
      annotations[0].geometry.coordinates = ms.geometry.pointBetween(points[0], points[1], 0.5);
