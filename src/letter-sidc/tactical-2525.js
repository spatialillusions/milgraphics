...
module.exports = function tacticalPoints(sidc, std2525) {
    ...
    sidc['G-T-J-----'] = ms.geometryConverter["CONTAIN"]; //TACGRP.TSK.CNT
    sidc['G-T-K-----'] = ms.geometryConverter["COUNTERATTACK"]; //TACGRP.TSK.CATK
    ...
    sidc['G-G-GLC---'] = ms.geometryConverter["LINE OF CONTACT"]; //TACGRP.C2GM.GNL.LNE.LOC
    ...
    sidc['G-G-ALC---'] = ms.geometryConverter["AIR CORRIDOR"];//TACGRP.C2GM.AVN.LNE.ACDR
    ...
    sidc['G-F-LCF---'] = ms.geometryConverter["FIRE SUPPORT COORDINATION LINE"]; //TACGRP.FSUPP.LNE.C2LNE.FSCL
    sidc['G-F-LCC---'] = ms.geometryConverter["COORDINATED FIRE LINE"]; //TACGRP.FSUPP.LNE.C2LNE.CFL
    sidc['G-F-LCN---'] = ms.geometryConverter["NO FIRE LINE"]; //TACGRP.FSUPP.LNE.C2LNE.NFL
